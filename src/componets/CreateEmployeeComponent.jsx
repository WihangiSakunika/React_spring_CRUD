        ...
        return (
            <div>
                <div className='container'>
                    <div className='row'>
                        <div className='card col-md-6 offset-md-3 offset-md-e'>
                            ...
                            <div className='card-body'>
                                <form>
                                    ...
                                    <div className='form-group'>
                                        ...
                                        <input placeholder='Email Id' name='emailId' className='form-control' value={this.state.emailId} onChange={this.changeEmailIdHandler}></input>
                                    </div>
